...
const candidateSchema = z.object({
    ...
    firstName: z.string().min(1, 'First name is required').regex(/^[A-Za-z]+$/, 'Only letters are allowed'),
    lastName: z.string().min(1, 'Last name is required').regex(/^[A-Za-z]+$/, 'Only letters are allowed'),
